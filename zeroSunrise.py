...
num_leds = 72  # Length of LED strip, in pixels
pin_go = B_pin  # GPIO pin numbers (Broadcom numbering) for 'go' button,
pin_next = R_pin  # previous image, next image and speed +/-.
pin_prev = L_pin
pin_faster = U_pin
pin_slower = D_pin
...
path = '/home/pi/zeroPainter/sunrise'  # USB stick mount point
...
duration = 180  # Image paint time, in seconds
...
speed_pixel = 1 #int(num_leds * (duration - min_time) / time_range)
